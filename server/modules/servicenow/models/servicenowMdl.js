...
exports.srvcnowcreatetaskMdl = function(data,empdata,crcktid,tasktypedata,emplnth, taskowner, pincodeSNdata){ 
	var mngr = 0;
	var sts = 218;
	var auto_asgn = 0;
	if(emplnth == 0){ 
...
exports.srvcnowcreateParenttaskMdl = function(data,empdata,crcktid,tasktypedata,emplnth, taskowner, taskno, serviceno, parentid){ 
...
exports.srvcnowcreateRiggertaskMdl = function(data,empdata,crcktid,tasktypedata,emplnth, taskowner, taskno, serviceno, parentid){ 
...
exports.updatetask_mobile_Mdl = function (data, user, callback) {
	...
	var QRY_TO_EXEC = `update tasks set last_updated_time = current_timestamp() ${qry} where service_no = '${data.service_no}' and call_attend_by=${data.call_attend_by};`;
